        ...
        <div class="row">
            <div class="col-12 mb-5">
                ...
                <form id="first" name="first" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4 offset-md-8 col-lg-2 offset-lg-10  text-right">
                            <input id="btnNextFirst" class="btn btn-primary btn-lg btn-block" value="Next" type="submit">
                        </div>
                    </div>
                </form>
                ...
                <form id="second" name="second" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4 offset-md-8 col-lg-2 offset-lg-10 text-right">
                            <button id="btnNextSecond" class="btn btn-primary btn-lg btn-block" value="Next"
                                    type="submit">Next
                            </button>
                        </div>
                    </div>
